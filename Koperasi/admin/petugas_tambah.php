...
<div class="content-wrapper">
    ...
    <?php
          $sql = $koneksi -> prepare("SELECT max(id_petugas) as id FROM petugas");
          $sql -> execute();
          $hsl = $sql -> fetch();
          $kode = $hsl['id'];
    ...
    <section class="content">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="proses/petugas_proses.php?agung=tambah" method="post">
                <div class="card-body" align=center>
                  <div class="alert alert-danger" role="alert">
                    Mohon ID Petugas untuk di ingat, karena akan di gunakan sebagai username untuk login. Password default adalah '123'
                  </div>
