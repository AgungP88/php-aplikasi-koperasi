      ...
      <!-- Default box -->
        <div class="card">
            <div class="card-header">
              <a href="petugas_tambah.php" rel="tooltip" title="Tambah Data">
                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                      ...
                      if(isset($_POST['search'])){
                        $param = $_POST['search'];
                        $asd = $koneksi->prepare("SELECT * FROM petugas WHERE id_petugas LIKE :1 OR nama LIKE :1 ");
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="petugas_edit.php?prabowo=<?php echo $data['id_petugas']; ?>" rel="tooltip" title="Edit">
                            <button type="button" name="button" class="btn btn-success"><i class="fa fa-cog"></i></button>
                            </a>
                            <a rel="tooltip" title="Hapus" href="proses/petugas_proses.php?agung=hapus&app=<?php echo $data['id_petugas']; ?>" onclick="return confirm('apakah anda yakin?')">
