      ...
      <!-- Default box -->
        <div class="card">
            <div class="card-header">
              <a href="angsuran_tambah.php" rel="tooltip" title="Tambah Data">
                <button type="button" name="button" class="btn btn-secondary"><i class="fa fa-plus"></i></button>
                </a>
                <a href="print/angsuran_print.php" rel="tooltip" title="Print" target="blank">
                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                      ...
                      if(isset($_POST['search'])){
                        $param = $_POST['search'];
                        $asd = $koneksi->prepare("SELECT * FROM angsuran WHERE id_anggota LIKE :1 OR id_angsuran LIKE :1 ");
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="angsuran_edit.php?prabowo=<?php echo $data['id_angsuran']; ?>" rel="tooltip" title="Edit">
                            <button type="button" name="button" class="btn btn-success"><i class="fa fa-cog"></i></button>
                            </a>
                            <a rel="tooltip" title="Hapus" href="proses/angsuran_proses.php?agung=hapus&app=<?php echo $data['id_angsuran']; ?>" onclick="return confirm('apakah anda yakin?')">
                            <button type="button" name="button" class="btn btn-danger" ><i class="fa fa-trash"></i></button>
                            </a>
                            <a target="blank" rel="tooltip" title="Print" href="print/angsuran_print_pcs.php?prabowo=<?php echo $data['id_angsuran']; ?>">
                            <button type="button" name="button" class="btn btn-primary" ><i class="fa fa-print"></i></button>
                          </td>
                        </tr>
                      </tbody>
