  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="utama_admin.php" class="nav-link">Home</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    <a href="utama_admin.php" class="nav-link">
                ...
                <!-- Menu 1 -->
                <?php
                if($_SESSION['username']['hak']=='admin'){
                ?>
                <li class="nav-item">
              ...
              <?php }else{ ?>
                <li class="nav-item">
                    <a href="profil_petugas.php" class="nav-link">
                        <i class="nav-icon fas fa-th"></i>
                        <p>Profil</p>
                    </a>
                </li>
              <?php } ?>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="anggota_admin.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="jenis_simpanan.php" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Jenis Simpanan</p>
                            </a>
                        </li>
