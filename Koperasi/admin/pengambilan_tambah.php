...
<div class="content-wrapper">
    ...
    <?php
          $sql = $koneksi -> prepare("SELECT max(id_pengambilan) as id FROM pengambilan");
          $sql -> execute();
          $hsl = $sql -> fetch();
          $kode = $hsl['id'];
    ...
    <section class="content">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Tambah Pengambilan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="proses/pengambilan_proses.php?agung=tambah" method="post">
                <div class="card-body" align=center>
                  <div class="form-group row">
                    <label for="IdAnggota" class="col-sm-3 col-form-label">ID Pengambilan</label>
                    <div class="col-sm-7" aling=center>
                      <input type="text" class="form-control" name="id_ambil" readonly value="<?php echo $new; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="NamaLengkap" class="col-sm-3 col-form-label">Tanggal Pengambilan</label>
                    <div class="col-sm-7">
                      <input type="date" class="form-control" name="tgl_ambil" placeholder="Nama Pinjaman" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-7" aling=center>
                      <input type="text" class="form-control" name="jumlah" placeholder="Jumlah Pengambilan" required >
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
