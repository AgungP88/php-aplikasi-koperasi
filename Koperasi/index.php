                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-xs-6">
					    <div class="small-box bg-blue">
						    ...
						    <p class="small-box-footer"><a href="#" style="color:white;">Pinjaman</a> <i class="fa fa-arrow-circle-right"></i></p>
					    </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box bg-green">
                            ...
                            <p class="small-box-footer"><a href="#" style="color:white;"> Angsuran </a><i class="fa fa-arrow-circle-right"></i></p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box bg-yellow">
                            ...
                            <p class="small-box-footer"> <a href="#" style="color:white;"> Simpanan </a><i class="fa fa-arrow-circle-right"></i></p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                        <div class="small-box bg-red">
                            ...
                            <p class="small-box-footer"><a href="#" style="color:white;"> Anggota </a><i class="fa fa-arrow-circle-right"></i></p>
                        </div>
                    </div>
