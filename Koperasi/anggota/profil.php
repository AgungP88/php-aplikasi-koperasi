    ...
    <section class="content">
      ...
      <!-- Default box -->
        <div class="card">
              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>ID : </b><a class="float-right"> <?php echo $hasil['id_anggota']; ?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Nama : </b> <a class="float-right"><?php echo $hasil['nama_lengkap']; ?></a>
                  </li>
                  <li class="list-group-item">
          ...
          <div class="col-md-9">
            <form action="profil_proses.php?agung=edit" method="post">
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#settings" data-toggle="tab">Profil</a></li>
                  <li class="nav-item"><a class="nav-link" href="#saldo" data-toggle="tab">Saldo</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                  ...
                  <div class="tab-pane" id="saldo">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        <label for="NamaLengkap" class="col-sm-3 col-form-label">Nama Lengkap</label>
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="nama" placeholder="Nama Lengkap" readonly value="<?php echo $hasil['nama_lengkap']; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="NamaLengkap" class="col-sm-3 col-form-label">Saldo</label>
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="nik" placeholder="Nomor Identitas" readonly value="<?php echo $hasil['saldo']; ?>">
                        </div>
                      </div>
                    </form>
                  </div>
