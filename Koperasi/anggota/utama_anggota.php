...
$simpanan = $koneksi -> prepare("SELECT * FROM simpanan WHERE id_anggota = '$metode'");
$simpanan -> execute();
$jumsimpanan = 0;
...
$pinjaman = $koneksi -> prepare("SELECT * FROM pinjaman WHERE id_anggota = '$metode'");
$pinjaman -> execute();
$jumpinjaman = 0;
...
$angsuran = $koneksi -> prepare("SELECT * FROM angsuran WHERE id_anggota = '$metode'");
$angsuran -> execute();
$jumangsuran = 0;
